                ...
                <div class="hero-slider hero-slider-one">
                    ...
                    <div class="hero-item">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="hero-image col">
                               <img src="/client/assets/images/hero/hero-1.png" alt="Hero Image">
                            </div>
                    ...
                    <div class="hero-item">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <!-- Hero Image -->
                            <div class="hero-image col">
                               <img src="/client/assets/images/hero/hero-2.png" alt="Hero Image">
                            </div>
                    ...
                    <div class="hero-item">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <!-- Hero Image -->
                            <div class="hero-image col">
                               <img src="/client/assets/images/hero/hero-3.png" alt="Hero Image">
                            </div>
    ...
    <div class="container">
        <div class="row row-10">
            ...
            <div class="col-md-8 col-12 mb-30">
                <div class="banner"><a href="#"><img src="/client/assets/images/banner/banner-1.jpg" alt="Banner"></a></div>
            </div>
            
            <!-- Banner -->
            <div class="col-md-4 col-12 mb-30">
                <div class="banner"><a href="#"><img src="/client/assets/images/banner/banner-2.jpg" alt="Banner"></a></div>
            </div>
...
<div class="product-section section mb-70">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mb-30">
                <div class="product-tab-filter">
                    ...
                    <ul class="nav product-tab-list">
                        ...
                        <li><a data-toggle="tab" href="#tab-two">${c.name }</a></li>
                        </c:forEach>
                    </ul>
         ...
         maxFractionDigits = "3" value = "${p.price}" />đ</h5>
                                                <div class="ratting">
                                ...
                                <div class="col pb-20 pt-10">
                                    ...
                                    <div class="ee-product">
                                        ...
                                        <div class="image">
                                            ...
                                            <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-6.png" alt="Product Image"></a>
                                            ...
                                            <a href="/cart/${p.id}" class="add-to-cart"><i class="ti-shopping-cart"></i><span>ADD TO CART</span></a>
                                ...
                                <div class="col pb-20 pt-10">
                                    ...
                                    <div class="ee-product">
                                        ...
                                        <div class="image">
                                            ...
                                            <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-7.png" alt="Product Image"></a>
                                ...
                                <div class="col pb-20 pt-10">
                                    ...
                                    <div class="ee-product">
                                        ...
                                        <div class="image">
                                            ...
                                            <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-8.png" alt="Product Image"></a>
                                ...
                                <div class="col pb-20 pt-10">
                                    ...
                                    <div class="ee-product">
                                        ...
                                        <div class="image">
                                            ...
                                            <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-9.png" alt="Product Image"></a>
                                ...
                                <div class="col pb-20 pt-10">
                                    ...
                                    <div class="ee-product">
                                        ...
                                        <div class="image">
                                            ...
                                            <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-10.png" alt="Product Image"></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12 pb-30 pt-10">
                        ...
                        <div class="ee-product">
                            ...
                            <div class="image">
                                ...
                                <a href="${request.contexPath}/product-detail/${p.id}" class="img"><img src="${p.image }" alt="Product Image"></a>
                            ...
                            <div class="content">
                                ...
                                <div class="category-title">
                                    ...
                                    <a href="#" class="cat">${p.category.name }</a>
                                    <h5 class="title"><a href="${request.contexPath}/product-detail/${p.id}">${p.name }</a></h5>
...
<div class="banner-section section mb-90">
    <div class="container">
        <div class="row">
            ...
            <!-- Banner -->
            <div class="col-12">
                <div class="banner"><a href="#"><img src="/client/assets/images/banner/banner-3.jpg" alt="Banner"></a></div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-30">
                ...
                <div class="feature feature-shipping">
                    <div class="feature-wrap">
                        <div class="icon"><img src="/client/assets/images/icons/feature-van.png" alt="Feature"></div>
                        <h4>Miễn phí giao hàng</h4>
                        <p>Hóa đơn từ 100.000đ</p>
                    </div>
                </div><!-- Feature End -->
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-30">
                ...
                <div class="feature feature-guarantee">
                    <div class="feature-wrap">
                        <div class="icon"><img src="/client/assets/images/icons/feature-walet.png" alt="Feature"></div>
                        <h4>Bảo hành 2 năm</h4>
                        <p>Nhận hàng trong vòng 15 ngày</p>
                    </div>
                </div><!-- Feature End -->
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-30">
                ...
                <div class="feature feature-security">
                    <div class="feature-wrap">
                        <div class="icon"><img src="/client/assets/images/icons/feature-shield.png" alt="Feature"></div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="offer-product-wrap row">
                    ...
                    <div class="col mb-30">
                        <div class="offer-time-wrap" style="background-image: url(/client/assets/images/bg/offer-products.jpg)">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-ratting">
                                                       ...
                                                       <h5 class="price"><span class="old"><fmt:formatNumber type = "number" 
												         maxFractionDigits = "3" value = "${p.price}" />đ</span><fmt:formatNumber type = "number" 
												         maxFractionDigits = "3" value = "${p.sale_price}" />đ</h5>
                                                        <div class="ratting">
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                        ...
                                        <div class="col pb-20 pt-10">
                                            ...
                                            <div class="ee-product">
                                                ...
                                                <div class="image">
                                                    ...
                                                    <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-18.png" alt="Product Image"></a>
                                        ...
                                        <div class="col pb-20 pt-10">
                                            ...
                                            <div class="ee-product">
                                                ...
                                                <div class="image">
                                                    ...
                                                    <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-24.png" alt="Product Image"></a>
                                        ...
                                        <div class="col pb-20 pt-10">
                                            ...
                                            <div class="ee-product">
                                                ...
                                                <div class="image">
                                                    ...
                                                    <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-20.png" alt="Product Image"></a>
                                        ...
                                        <div class="col pb-20 pt-10">
                                            ...
                                            <div class="ee-product">
                                                ...
                                                <div class="image">
                                                    ...
                                                    <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-21.png" alt="Product Image"></a>
                                        ...
                                        <div class="col pb-20 pt-10">
                                            ...
                                            <div class="ee-product">
                                                ...
                                                <div class="image">
                                                    ...
                                                    <a href="single-product.html" class="img"><img src="/client/assets/images/product/product-22.png" alt="Product Image"></a>
...
<div class="banner-section section mb-60">
    <div class="container">
        <div class="row">
            ...
            <!-- Banner -->
            <div class="col-md-4 col-12 mb-30">
                <div class="banner"><a href="#"><img src="/client/assets/images/banner/banner-4.jpg" alt="Banner"></a></div>
            </div>
            
            <!-- Banner -->
            <div class="col-md-4 col-12 mb-30">
                <div class="banner"><a href="#"><img src="/client/assets/images/banner/banner-5.jpg" alt="Banner"></a></div>
            </div>
            
            <!-- Banner -->
            <div class="col-md-4 col-12 mb-30">
                <div class="banner"><a href="#"><img src="/client/assets/images/banner/banner-6.jpg" alt="Banner"></a></div>
            </div>
...
<div class="popup-subscribe-section section bg-gray pt-55 pb-55" data-modal="popup-modal">
    ...
    <div class="popup-subscribe-wrap">
        ...
        <div class="popup-subscribe-banner banner">
            <a href="#"><img src="/client/assets/images/banner/banner-7.jpg" alt="Banner"></a>
        </div>
